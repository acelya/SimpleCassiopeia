...
function AutoUpdate(data)
    if tonumber(data) > tonumber(ver) then
        ...
        DownloadFileAsync("https://rawgit.com/acelya/SimpleCassiopeia/master/SimpleCassiopeia.lua", SCRIPT_PATH .. "SimpleCassiopeia.lua", function() print("Update Complete, please 2x F6!") return end)
    end
end
--MENU
