...
function AutoUpdate(data)
    if tonumber(data) > tonumber(ver) then
        ...
        DownloadFileAsync("https://github.com/acelya/SimpleCassiopeia.git", SCRIPT_PATH .. "SimpleCassiopeia.lua", function() print("Update Complete, please 2x F6!") return end)
    end
end
--MENU
